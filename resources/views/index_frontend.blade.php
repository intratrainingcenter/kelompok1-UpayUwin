    ...
    <div class="row no-gutters pb-5">
        <div class="col-sm-4">
            <div class="hovereffect">
                <img class="img-fluid" src="{{asset('FrontEnd1')}}/images/a1.jpg" alt="">
                <div class="overlay">
        ...
        <div class="col-sm-4">
            <div class="hovereffect">
                <img class="img-fluid" src="{{asset('FrontEnd1')}}/images/a2.jpg" alt="">
                <div class="overlay">
                    <h5>men's fashion</h5>
        ...
        <div class="col-sm-4">
            <div class="hovereffect">
                <img class="img-fluid" src="{{asset('FrontEnd1')}}/images/a3.jpg" alt="">
                <div class="overlay">
                    <h5>kid's fashion</h5>
